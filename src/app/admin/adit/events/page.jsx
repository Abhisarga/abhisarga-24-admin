            ...
            <Arena>
                ...
                <FormCard mutation={CREATE_EVENT_MUTATION}>
                    <FormHeader>
                        ...
                        <FormDescription
                            description={'Put the details of event here'}
                        />
                    </FormHeader>
                    ...
                    <SelectDropDown
                        ...
                        label={'Host Club'}
                    >
                        <option data-value="something" value="aesfhjasdkf">
                            Nirvana
                        </option>
                        <option data-value="something" value="Enigma">
                            Enigma
                        </option>
                        <option data-value="something" value="GDSC">
                            Eniota
                        </option>
                        <option data-value="something" value="IOTA">
                            Enpota
                        </option>
                        <option data-value="something" value="Meraki">
                            Meraki
                        </option>
                    </SelectDropDown>
                    ...
                    <InputBox
                        id={'prizePool'}
                        label={'Prize Pool'}
                        placeholder={'Enter event prize pool'}
                    />
                            ...
                            return (
                                <>
                                    ...
                                    >
                                        <RadioItem
                                            itemKey={'Online'}
                                            id={`round.mode.online.${lid}`}
                                            groupName={`rounds-${lid}.mode`}
                                            value={'online'}
                                        />
                                        <RadioItem
                                            itemKey={'Offline'}
                                            id={`round.mode.offline.${lid}`}
                                            groupName={`rounds-${lid}.mode`}
                                            value={'offline'}
                                        />
                                        <RadioItem
                                            itemKey={'Hybrid'}
                                            id={`round.mode.hybrid.${lid}`}
                                            groupName={`rounds-${lid}.mode`}
                                            value={'hybrid'}
                                        />
                                    </RadioGroup>
                                    ...
                                    <ListInput
                                        ...
                                        getContent={(lidInner) => {
                                            return (
                                                <>
                                                    <SelectDropDown
                                                        id={`rounds-${lid}.organizers-${lidInner}`}
                                                        label={'Organizer Name'}
                                                        placeholder={
                                                            'Search and Select organizer name'
                                                        }
                                                    >
                                                        <option value="data">
                                                            data
